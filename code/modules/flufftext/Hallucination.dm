...
/datum/hallucination/chat/New(mob/living/carbon/C, forced = TRUE, force_radio, specific_message)
	...
	var/speak_messages = list("[pick_list_replacements(HAL_LINES_FILE, "suspicion")]",\
		...
		"Jestem chory, [pick_list_replacements(HAL_LINES_FILE, "infection_advice")]!")
	...
	var/radio_messages = list("[pick_list_replacements(HAL_LINES_FILE, "people")] jest [pick_list_replacements(HAL_LINES_FILE, "accusations")]!",\
		...
		"[pick("Wezwijcie","Ai, wezwij","Niech ktoś wezwie","Niech ktoś odwoła")] prom ratunkowy!",\
		"AI [pick("jest wroga", "nie żyje")]!!")
