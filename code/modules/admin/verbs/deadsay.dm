/client/proc/dsay(msg as text)
	...
	var/rendered = "<span class='game deadsay'><span class='prefix'>MARTWY:</span> <span class='name'>[rank_name]([admin_name])</span> mówi, <span class='message'>\"[emoji_parse(msg)]\"</span></span>"
