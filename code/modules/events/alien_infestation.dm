...
/datum/round_event/ghost_role/alien_infestation/announce(fake)
	...
	if(living_aliens || fake)
		priority_announce("Wykryto niezidentyfikowane formy życia na pokładzie [station_name()]. Należy zabezpieczyć wentylacje.", "Obca forma życia", 'sound/ai/aliens.ogg')
